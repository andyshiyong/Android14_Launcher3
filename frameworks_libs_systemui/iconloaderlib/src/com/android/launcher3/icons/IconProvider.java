        ...
        if (icon == null) {
            ...
            if (ATLEAST_T && icon instanceof AdaptiveIconDrawable && td != null) {
                ...
                if  (aid.getMonochrome() == null) {
                    ...
                    Log.d(TAG, "xyj   getIconWithOverrides " + packageName);
                }
            }
        }
        return icon;
    ...
    private Drawable loadActivityInfoIcon(ActivityInfo ai, int density) {
        ...
        if (density != 0 && iconRes != 0) {
            try {
                ...
                //////////////////////////////////
                //Log.d(TAG, "xyj   loadActivityInfoIcon " + ai.packageName + " " + density);
                icon = mContext.getPackageManager().getDrawable(ai.packageName, iconRes, null);
                if(icon == null) icon = resources.getDrawableForDensity(iconRes, density);
                //////////////////////////
