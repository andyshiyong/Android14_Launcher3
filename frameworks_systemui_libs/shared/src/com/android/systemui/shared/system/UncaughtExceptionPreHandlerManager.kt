...
//        val currentHandler = Thread.getUncaughtExceptionPreHandler()//系统编译用
        val currentHandler = Thread.getDefaultUncaughtExceptionHandler()//studio编译用
...
//            Thread.setUncaughtExceptionPreHandler(globalUncaughtExceptionPreHandler)//系统编译用
            Thread.setDefaultUncaughtExceptionHandler(globalUncaughtExceptionPreHandler)//studio编译用
        }
    }
