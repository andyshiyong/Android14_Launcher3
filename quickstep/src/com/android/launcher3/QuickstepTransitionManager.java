...
public class QuickstepTransitionManager implements OnDeviceProfileChangeListener {
    ...
    public void registerRemoteAnimations() {
        ...
        if (hasSimpleAnimationTransition()) {
    ...
    public boolean hasSimpleAnimationTransition() {
        return true;
    }
    ...
    public Pair<RectFSpringAnim, AnimatorSet> createWallpaperOpenAnimations(
        ...
        if (anim == null) {
            ...
            if (fromUnlock) {
                ...
                if (launcherView != null && launcherView instanceof BubbleTextView) {
                    ((BubbleTextView) launcherView).prepareDrawDragView();
                }
